...
exe = EXE(pyz,
          ...
          name=os.path.join('build/electrum-xgox/electrum-xgox', cmdline_name))
...
tctl_exe = EXE(tctl_pyz,
           ...
           upx=False,
           console=True,
           name=os.path.join('build/electrum-xgox/electrum-xgox', 'trezorctl.bin'))
...
app = BUNDLE(coll,
             name=os.path.join('dist', 'Electrum-XGOX.app'),
             appname="Electrum-XGOX",
	         icon='electrum-xgox.icns',
