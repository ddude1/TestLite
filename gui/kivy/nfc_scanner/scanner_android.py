...
from electrum_xgox_gui.kivy.nfc_scanner import NFCBase
...
class ScannerAndroid(NFCBase):
    ...
    def create_AAR(self):
        ...
        '''
        return NdefRecord.createApplicationRecord(JString("org.electrum-xgox.kivy"))

    def create_TNF_EXTERNAL(self, data):
        '''Create our actual payload record.
        '''
        if BUILDVERSION >= 14:
            domain = "org.electrum-xgox"
            stype = "externalType"
            ...
            extRecord = NdefRecord(
                ...
                "org.electrum-xgox:externalType",
                '',
                data)
        return extRecord
