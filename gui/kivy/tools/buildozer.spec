...
# (str) Package name
package.name = Electrum_XGOX

# (str) Package domain (needed for android/ios packaging)
package.domain = com.xgoxcoin
...
requirements = python3crystax, android, openssl, plyer, kivy==1.10.0, xevan_hash
...
icon.filename = %(source.dir)s/icons/electrum_xgox.png
...
android.add_activities = com.xgoxcoin.qr.SimpleScannerActivity
