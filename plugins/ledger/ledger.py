...
from electrum_xgox.bitcoin import (TYPE_ADDRESS, int_to_hex, var_int,
...
from electrum_xgox.util import print_error, is_verbose, bfh, bh2u
    ...
    def checkDevice(self):
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00):
                    raise BaseException("Device not in Xuez mode")
                raise e
