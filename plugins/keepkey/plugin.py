...
from electrum_xgox.util import bfh, bh2u
from electrum_xgox.bitcoin import (b58_address_to_hash160, xpub_from_pubkey,
                              TYPE_ADDRESS, TYPE_SCRIPT, NetworkConstants)
from electrum_xgox.i18n import _
from electrum_xgox.plugins import BasePlugin
from electrum_xgox.transaction import deserialize
from electrum_xgox.keystore import Hardware_KeyStore, is_xpubkey, parse_xpubkey
...
class KeepKeyCompatiblePlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Xgox Testnet" if NetworkConstants.TESTNET else "Xgox"
